...
- [ ] **环境变量表格** (`ui/components/env_table.py`)
  - [ ] 设计QTableWidget或QTableView
  - [ ] 实现变量列表显示
  - [ ] 添加右键上下文菜单
  - [ ] 实现排序和筛选
  - [ ] 添加多选支持
...
- [ ] **搜索组件** (`ui/components/search_widget.py`)
  - [ ] 创建搜索输入框
  - [ ] 实现实时搜索过滤
  - [ ] 添加搜索选项（变量名/值）
  - [ ] 支持正则表达式搜索
...
- [ ] **PATH编辑器组件** (`ui/components/path_editor.py`)
  - [ ] 设计路径列表显示组件
  - [ ] 实现路径的增删改功能
  - [ ] 添加拖拽排序支持
  - [ ] 实现路径状态显示（有效/无效）
